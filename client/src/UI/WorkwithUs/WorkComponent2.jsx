...
function WorkComponent2() {
  ...
  return (
    <div className=' min-h-[100vh] w-full bg-[] flex flex-col items-center'>
        <section className=' h-[100px] w-full bg-[] flex flex-col justify-center items-center'>
            <h1 className=' text-[25px] md:text-[30px]'>Flexible Job and Great Fees</h1>
        ...
        <section className=" min-h-[250px] w-[100%] md:w-[100%] lg:w-[100%] mt-5 bg-[] grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="min-h-[200px] bg-white grid grid-cols-[20%,80%]">
                ...
                <div className="bg-[]">
                    <h1 className=' text-[25px] md:text-[30px]'>Great Fees</h1>
            ...
            <div className="min-h-[200px] bg-white grid grid-cols-[20%,80%]">
                ...
                <div className="bg-[]">
                    <h1 className=' text-[25px] md:text-[30px]'>Growing Possibility</h1>
            ...
            <div className="min-h-[200px] bg-white grid grid-cols-[20%,80%]">
                ...
                <div className="bg-[]">
                    <h1 className=' text-[25px] md:text-[30px]'>Manage your own orders via App</h1>
 ...
 <div className="min-h-[200px] bg-white grid grid-cols-[20%,80%]">
                ...
                <div className="bg-[]">
                    <h1 className=' text-[25px] md:text-[30px]'>Work in a small area</h1>
            ...
            <div className="min-h-[200px] bg-white grid grid-cols-[20%,80%]">
                ...
                <div className="bg-[]">
                    <h1 className=' text-[25px] md:text-[30px]'>Flexible time</h1>
            ...
            <div className="min-h-[200px] bg-white grid grid-cols-[20%,80%]">
                ...
                <div className="bg-[]">
                    <h1 className=' text-[25px] md:text-[30px]'>Flexible days</h1>
